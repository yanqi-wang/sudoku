...
namespace SudokuKata
{
    class Program
    {
        ...
        public void Play()
        {
            ...
            PopulateGameBoard(out var rng, out var stateStack, out var rowIndexStack, out var colIndexStack, out var usedDigitsStack, out var lastDigitStack, out var command, out var board);
        ...
        public void Temp4(ref int[] candidateMasks, Dictionary<int, int> maskToOnesCount, ref Dictionary<int, int> singleBitToIndex, ref Random rng,
            ref int[] state, ref char[][] board, ref bool changeMade, ref string command, ref Stack<int[]> stateStack, int[] finalState, ref Stack<int> rowIndexStack, ref Stack<int> lastDigitStack, ref Stack<bool[]> usedDigitsStack, ref Stack<int> colIndexStack)
        {
